...
def generate_noise(size,num_samp=1,device='cuda',type='gaussian', scale=1):
    ...
    # print("noise function",noise.shape)
    return noise
...
# def read_image(opt):    # reads images and converts to torch tensors of shape[1,3,256,256] 
#     print("here2")
#     print(opt.input_dir,opt.input_name)
